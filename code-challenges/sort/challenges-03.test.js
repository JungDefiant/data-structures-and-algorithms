...
const sortBackwards = (arr) => {
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl < higherEl) {
            return 1;
        } else if (lowerEl > higherEl) {
            return -1;
        } else {
            return 0;
        }
...
const sortByLength = (arr) => {
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl.length < higherEl.length) {
            return -1;
        } else if (lowerEl.length > higherEl.length) {
            return 1;
        } else {
            return 0;
        }
...
const alphabetizeBetter = (arr) => {
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl.toLowerCase() < higherEl.toLowerCase()) {
            return -1;
        } else if (lowerEl.toLowerCase() > higherEl.toLowerCase()) {
            return 1;
        } else {
            return 0;
        }
...
const sortByPrice = (arr) => {
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl.price < higherEl.price) {
            return -1;
        } else if (lowerEl.price > higherEl.price) {
            return 1;
        } else {
            return 0;
        }
...
const sortNumbersByLength = (arr) => {
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl.toString().length < higherEl.toString().length) {
            return -1;
        } else if (lowerEl.toString().length > higherEl.toString().length) {
            return 1;
        } else {
            return 0;
        }
...
const sortPeople = (arr) => {
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl.lastName < higherEl.lastName) {
            return -1;
        } else if (lowerEl.lastName > higherEl.lastName) {
            return 1;
        } else {
            return 0;
        }
...
const sortPeopleBetter = (arr) => {
    // Credit: Chance Harmon
    return arr.sort((lowerEl, higherEl) => {
        if (lowerEl.lastName === higherEl.lastName && lowerEl.firstName === higherEl.firstName) {
            return lowerEl.age > higherEl.age;
        } else if (lowerEl.lastName === higherEl.lastName) {
            return lowerEl.firstName > higherEl.firstName;
        } else {
            return lowerEl.lastName > higherEl.lastName;
        }
    });
};
